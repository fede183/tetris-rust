...
pub fn generate_rectangle_with_border(positions: Vec3, height: f32, wigth: f32, border_size: f32, fill_color: Color, border_color: Color) -> [SpriteBundle; 2] {
    [
        generate_rectangle(Vec3 { z: positions.z + 1., ..positions }, height, wigth, fill_color),
